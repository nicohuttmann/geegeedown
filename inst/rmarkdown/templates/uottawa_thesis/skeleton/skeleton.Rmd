...
It was adapted from [nkurzaw/heididown](https://github.com/nkurzaw/heididown) that 
in turn is based on [phister/huwiwidown](https://github.com/phister/huwiwidown) that 
